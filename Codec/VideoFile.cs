...
namespace Codec
{
    ...
    class VideoFile
    {
        ...
        public VideoFile(int keyFrameEvery, int width, int height, BitArray[] YBitArray, BitArray[] CbBitArray, BitArray[] CrBitArray, Huffman<int>[] YHuffmans, Huffman<int>[] CbHuffmans, Huffman<int>[] CrHuffmans)
        {
